...
//   s21::multiset<int> s1 = {3, 3, 5, 2, 2};
//   std::multiset<int> s2 = {3, 3, 5, 2, 2};
...
//   for (my_multiset_it = s1.begin(); my_multiset_it != s1.end();
//        ++my_multiset_it, ++std_multiset_it) {
...
//   EXPECT_EQ(s1.contains(2), s2.contains(2));
//   EXPECT_EQ(s1.contains(5), s2.contains(5));
//   EXPECT_EQ(s1.contains(1), s2.contains(1));
//   EXPECT_EQ(s1.contains(3), s2.contains(3));
//   EXPECT_EQ(s1.contains(4), s2.contains(4));
// }
